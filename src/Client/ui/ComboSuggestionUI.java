...
public class ComboSuggestionUI extends BasicComboBoxUI {
	...
	protected ListCellRenderer<Object> createRenderer() {
		...
		return new ListCellRenderer() {
			...
			public Component getListCellRendererComponent(JList jlist, Object e, int i, boolean bln,
				...
				if (i >= 0)
					label.setBorder(new EmptyBorder(2, 8, 2, 8)); // Khoang cach giua cac item
				else {
	...
	@Override
	public void paintCurrentValueBackground(Graphics grphs, Rectangle rctngl, boolean bln) {
	...
	private class ComboSuggestionPopup extends BasicComboPopup {
		...
		protected JScrollPane createScroller() {
			...
			list.setBackground(Color.white); // Thay doi background cua popup
...
//			sb.setPrefe
	...
	private class ArrowButton extends JButton {
		...
		public ArrowButton() {
			...
			setBackground(new Color(150, 150, 150, 150));
		}
