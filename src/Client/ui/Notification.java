...
public class Notification extends javax.swing.JComponent {
    ...
    private void init(String message) {
        ...
        if (type == Type.SUCCESS) {
            lbIcon.setIcon(new javax.swing.ImageIcon(".\\src\\Client\\ui\\logo\\sucess.png"));
            lbMessage.setText("Success");
        } else if (type == Type.INFO) {
            lbIcon.setIcon(new javax.swing.ImageIcon(".\\src\\Client\\ui\\logo\\info.png"));
            lbMessage.setText("Info");
        } else {
            lbIcon.setIcon(new javax.swing.ImageIcon(".\\src\\Client\\ui\\logo\\warning.png"));
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(".\\src\\Client\\ui\\logo\\sucess.png")); // NOI18N
        ...
        cmdClose.setIcon(new javax.swing.ImageIcon(".\\src\\Client\\ui\\logo\\close.png")); // NOI18N
